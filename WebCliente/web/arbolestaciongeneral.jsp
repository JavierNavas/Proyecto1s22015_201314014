<%-- 
    Document   : arbolestaciongeneral
    Created on : 19-sep-2015, 8:43:52
    Author     : javier
--%>
...
<head>
   ...
   ================================================== -->
   <meta charset="utf-8">
	<title>Arbol Estacion General</title>
...
<body>
	      ...
	      <nav id="nav-wrap">         
	         ...
	         <ul id="nav" class="nav">
	            <li><a href="Graficos.jsp">InicioGrafico.</a></li>
                    <li  ><a href="arboladmi.jsp"> A Administrador.</a></li>
	            <li ><a href="arbolestacionclave.jsp">A Estacion Clave.</a></li>
	            <li lass="current"><a href="arbolestaciongeneral.jsp">A Estacion General.</a></li>
   ...
   <section id="page-title">	
		...
		<div class="row">
			...
			<div class="twelve columns">
				...
				<h1>Arbol Estacion General<span>.</span></h1>
				<p>La imagen de abajo es la estructura de Estacion General</p>
   ...
   <section id="content">
     <div class="row portfolio-content">
                   <form name="agregaresg" action="arbolestaciongeneral.jsp" method="post">
                        <%
    try {
        String tipo="EstacionGeneral";
    ...
    %>
			 <img src="http://localhost:8080/MY-APP/img/ArbolEstacionG.jpg" width="1875" height="2847" alt="" name="imagen1" id="imagen1"/>
