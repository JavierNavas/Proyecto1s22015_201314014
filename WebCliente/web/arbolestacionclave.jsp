<%-- 
    ...
    Created on : 19-sep-2015, 11:55:45
    Author     : javier
--%>
...
<head>
   ...
   ================================================== -->
   <meta charset="utf-8">
	<title>Arbol Estacion Clave</title>
...
<body>
   	...
   	<div class="row header-inner">
	      ...
	      <nav id="nav-wrap">         
	         ...
	         <ul id="nav" class="nav">
	            ...
	            <li lass="current"><a href="arbolestacionclave.jsp">A Estacion Clave.</a></li>
   ...
   <section id="page-title">	
		...
		<div class="row">
			...
			<div class="twelve columns">
				...
				<h1>Arbol Estacion Clave<span>.</span></h1>
				<p>La imagen de abajo es la estructura de Estacion Clave</p>
   ...
   <section id="content">
     <div class="row portfolio-content">
                   <form name="agregares" action="arbolestacionclave.jsp" method="post">
                        <%
    try {
        String tipo="EstacionClave";
    ...
    %>
			 <img src="http://localhost:8080/MY-APP/img/ArbolEstacionC.jpg" width="1875" height="2847" alt="" name="imagen1" id="imagen1"/>
