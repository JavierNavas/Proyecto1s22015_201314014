<%-- 
    Document   : Graficos
    Created on : 19-sep-2015, 8:42:34
    Author     : javier
--%>
...
<body>
   ...
   <header id="main-header">
   	...
   	<div class="row header-inner">
	      ...
	      <nav id="nav-wrap">         
	         ...
	         <ul id="nav" class="nav">
	            <li lass="current"><a href="Graficos.jsp">InicioGrafico.</a></li>
   ...
   <section id="page-title">	
		...
		<div class="row">
			...
			<div class="twelve columns">
				...
				<h1>Graficos De estructuras<span>.</span></h1>
				<p>Seleccione una opcion del menu para mostrar estructura</p>
   ...
   <section id="content">
     <div class="row portfolio-content">
                   <form name="agregarbu" action="ModuloRuta.jsp" method="post">
