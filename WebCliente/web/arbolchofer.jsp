<%-- 
    ...
    Created on : 19-sep-2015, 8:43:35
    Author     : javier
--%>
...
<body>
   	...
   	<div class="row header-inner">
	      ...
	      <nav id="nav-wrap">         
	         ...
	         <ul id="nav" class="nav">
	            ...
	            <li lass="current"><a href="arbolchofer.jsp">A Chofer.</a></li>
   ...
   <section id="page-title">	
		...
		<div class="row">
			...
			<div class="twelve columns">
				...
				<h1>Arbol Chofer<span>.</span></h1>
				<p>La imagen de abajo es la estructura de Chofer</p>
   ...
   <section id="content">
     <div class="row portfolio-content">
                   <form name="agregarbu" action="arbolchofer.jsp" method="post">
                        <%
    try {
        String tipo="Chofer";
    ...
    %>
			 <img src="http://localhost:8080/MY-APP/img/ArbolChofer.jpg" width="1875" height="2847" alt="" name="imagen1" id="imagen1"/>
