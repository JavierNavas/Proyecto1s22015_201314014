<%-- 
    Document   : ListaB
    Created on : 19-sep-2015, 11:56:28
    Author     : javier
--%>
...
<body>
	      ...
	      <nav id="nav-wrap">         
	         ...
	         <ul id="nav" class="nav">
	            ...
	            <li ><a href="arbolestaciongeneral.jsp">A Estacion General.</a></li>
                    <li lass="current"><a href="ListaB.jsp">L Bus.</a></li>
   ...
   <section id="page-title">	
		...
		<div class="row">
			...
			<div class="twelve columns">
				...
				<h1>Lista Bus<span>.</span></h1>
				<p>La imagen de abajo es la estructura de los buses</p>
   ...
   <section id="content">
     <div class="row portfolio-content">
                   <form name="agregaresg" action="ListaB.jsp" method="post">
                        <%
    try {
        String tipo="Bus";
    ...
    %>
			 <img src="http://localhost:8080/MY-APP/img/ListaBus.jpg" width="1875" height="2847" alt="" name="imagen1" id="imagen1"/>
