...
public class ArbolEstacionC {
     public ListaC ce= new ListaC();
 private EstacionClave raiz;
    int numero;
    int numero2;
    String error="";
    ...
    public boolean insertar(int id,String nombre,String contra) {
     ...
     EstacionClave nuevo= new EstacionClave(id,nombre,contra);
    ...
    public void insertarAVL(EstacionClave p, EstacionClave q) {
    ...
    public void recursivoBalance(EstacionClave cur) {
    ...
    private void setBalance(EstacionClave cur) {
      cur.fe = altura(cur.hijoDerecho)-altura(cur.hijoIzquierdo);
    }
    
    //Resegresa la altura
    private int altura(EstacionClave cur) {
      if(cur==null) {
      return -1;
      }
 ...
 public EstacionClave rotarIzquierda(EstacionClave n) {
  
  EstacionClave v = n.hijoDerecho;
  v.padre = n.padre;
  ...
  public EstacionClave rotarDerecha(EstacionClave n) {
  
  EstacionClave v = n.hijoIzquierdo;
  v.padre = n.padre;
  ...
  return v;
   ...
   public EstacionClave dobleRotarIzquierdaDerecha(EstacionClave u) {
     u.hijoIzquierdo = rotarIzquierda(u.hijoIzquierdo);
   return rotarDerecha(u);
   }
 
   public EstacionClave dobleRotarDerechaIzquierda(EstacionClave u) {
   ...
   public void eliminarAVL(EstacionClave p,int q) {
     if(p==null) {
   ...
   public void eliminarNodoEncontrado(EstacionClave q) {
     EstacionClave r;
   ...
   // balanceando
    ...
    public EstacionClave sucesor(EstacionClave q) {
       if(q.hijoDerecho!=null) {
         EstacionClave r = q.hijoDerecho;
         while(r.hijoIzquierdo!=null) {
         r = r.hijoIzquierdo;
       }
       return r;
       }else{
        EstacionClave p = q.padre;
     ...
     public void recorrerInOrden(EstacionClave x){
          if(x!=null){
      ...
      public void recorrerPreOrden(EstacionClave x){
          if(x!=null){
           System.out.print(x.id+", ");
      ...
      public void recorrerPostOrden(EstacionClave x){
          if(x!=null){
      ...
      public void recorrerPostOrdenM(EstacionClave x){
          if(x!=null){
           recorrerPostOrdenM(x.hijoIzquierdo);
           recorrerPostOrdenM(x.hijoDerecho);
            ce.agregar(new C(x.nombre));
          }else{
      ...
      //metodo Buscar
      public EstacionClave buscar(int id, EstacionClave r){
        if(raiz==null){
            return null;
        }else if(r==null){
            return r;
      ...
      public boolean Modificar(int idAntiguo,int nuevoid,String nombre,String con){
        EstacionClave temp = buscar(idAntiguo,raiz);
...
public static String getDotFile(ArbolEstacionC t){
...
private static StringBuilder getDotTreeContent(StringBuilder sb, EstacionClave n, int i){
    if(n!=null){
